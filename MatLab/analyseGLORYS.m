...
clearvars timeDat SOURCE DESTINATION
%~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
%~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
fs = get(gca, 'FontSize');
set(gca, 'FontSize', 1.8 * fs)
set(gca, 'YTickLabelRotation', 90)
yt = get(gca, 'YTick');
ytl = get(gca, 'YTickLabel');
set(gca, {'YTick', 'YTickLabel'}, {yt(1:end-1), ytl(1:end-1)})
...
% months = timeDat.month(1:end); % choose a range of months
months = timeDat.month(4); % or a single month
nmonths = length(months);
imonths = ismember(timeDat.month, months);
...
displayDepth = false; % show the depth/month
displayMonth = false; % as row/column labels
monthLabAdj = 0.15;
...
for i = 1:npanels
    ...
    switch displayDepth, case true
        % Only makes sense when multiple depths are plotted... hmmm, maybe not
...
%     filename = 'GLORYS seawater density maps_Jan2019_100m.png';
